...
export function EntityCard({
  ...
  return (
    <Link href={href} className="group flex items-center gap-4 rounded-2xl border border-borderSoft bg-white p-4 shadow-sm transition hover:border-violet-200 hover:shadow-card">
      ...
      <span className="min-w-0">
        ...
        {meta ? <span className="mt-1 block truncate text-sm text-slate-500">{meta}</span> : null}
      </span>
    </Link>
  );
}
