  ...
  return (
    <div className="space-y-6">
      <section className="rounded-3xl border border-borderSoft bg-white p-6 shadow-card">
        <h1 className="text-3xl font-black text-slate-950">Upcoming Events</h1>
        <p className="mt-3 max-w-3xl text-sm leading-7 text-slate-600">Find music events and live experiences published by the Musichub team.</p>
      </section>
